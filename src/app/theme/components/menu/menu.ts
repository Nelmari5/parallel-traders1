...
export const verticalMenuItems = [ 
    ...
    new Menu (1, 'Dashboard', '/loggedin/dashboard', null, null, null, false, 0),
    new Menu (2, 'Arbitrage', '/loggedin/arbitrage', null, null, null, false, 0), 
    new Menu (3, 'Profile', '/loggedin/profile', null, null, null, false, 0),
    new Menu (4, 'Log Out', '/loggedin/logout', null, null, null, false, 0), 
    ...
    // new Menu (50, 'Profile', null, null, 'person', null, true, 0),
    // new Menu (51, 'Projects', '/profile/projects', null, 'note', null, false, 0),    
...
export const adminMenuItems = [ 
    ...
    new Menu (1, 'Arbitrage Registrations', '/admin/arb-users', null, null, null, false, 0),
    new Menu (4, 'Log Out', '/loggedin/logout', null, null, null, false, 0), 
]

export const horizontalMenuItems = [ 
    new Menu (1, 'Dashboard', '/loggedin/dashboard', null, 'dashboard', null, false, 0),
    new Menu (2, 'Arbitrage', '/loggedin/arbitrage', null, 'supervisor_account', null, false, 0), 
